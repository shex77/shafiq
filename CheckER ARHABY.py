...
print ("$ [1] checker : ")
print ("$ [2] list maker : ")
ali = input('$ Enter number : ')

if ali == '1':
	print('\n━━━━━━━━━━━━━━━ INSTA RAHABY ━━━━━━━━━━━━━━━━')
	sl = int(input('[+] Enter sleep (10 / 5) : '))
	...
	def gml():
		...
		if ',null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,[]' in req:
			print(f'[Gmail]> Available == \n{eml}\n')
			
			with open ('[$] Available.txt', 'a') as x:
				x.write ('[gmail]> '+ eml + '\n')
		else:
			print(f'[Gmail] Not Available == \n{eml}\n')
	...
	while True:
		...
		if '"can_recover_with_code":false' in req.text:
			print(f'connected to insta>> {eml} ')
			...
			print(f'not connected to insta == \n{eml}\n')
		time.sleep(sl)
